...
Why might you need a physically based model rather than a statistical model? predict streamflow, likely needs to be spatial, how does a fire affect streamflow

What are some key processes that need to be represented? how water moves through watershed, how vegetation effects water availability, forest water use, evaporation
...
Example Q2: As trees age does "hardening" of the arteries - e.g reduced rates of water flow in the xylem, impact their water use (evapotranspiration)? (too much complexity for previous question!)
